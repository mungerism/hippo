...
3. **Docs as Code 协同约定**：
   - 优先阅读 [`docs/index.md`](../index.md) 与 [`docs/architecture/`](../architecture/index.md) 获取最新系统架构与数据流；
   - 新的重要技术选型写入 ADR（[`docs/adr/`](../adr/index.md)），尚未确定的方案编写 RFC（[`docs/rfcs/`](../rfcs/index.md)）；
