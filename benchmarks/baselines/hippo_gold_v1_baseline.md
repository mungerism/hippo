...
- **运行 ID**: `eval_hippo_gold_v1_1790321517`
- **时间戳**: `2026-09-25T07:29:04.948434+00:00`
- **Git SHA**: `85a0dd3a151c355a191e80a98ce232876235a2c0`
- **数据集 Hash**: `8fbec7da0bfdd2c1...`
- **Mem0 版本**: `2.0.20` | **Hippo 版本**: `0.1.0`
- **Adapter / Ingest**: `HippoEngineAdapter` / `direct-facts`
- **评测耗时**: `172.6482s` (共 210 道题目)
...
| **Hard-Negative FPR** (硬负样本假阳率) | **1.25%** | <= 2.00% | ✅ 合规 |
...
| :--- | :---: | :---: | :---: | :---: |
| **Recall (召回率)** | 0.6058 | **0.6660** | 0.6660 | 0.6660 |
| **Precision (精准度)** | 0.6385 | **0.2385** | 0.1431 | 0.0715 |
| **Hit Rate (命中率)** | 0.6385 | **0.6923** | 0.6923 | 0.6923 |
| **nDCG (排序得分)** | 0.6385 | **0.6569** | 0.6556 | 0.6556 |
| **Forbidden Leakage (安全泄漏数)** | 0.0000 | **0.0000** | 0.0000 | 0.0000 |
| **Empty Accuracy (无答案置空率)** | 0.9875 | **0.9875** | 0.9875 | 0.9875 |
| **Candidate Recall@20** (粗筛上限) | - | - | - | **0.9974** |
| **MRR (平均倒数排名)** | - | **0.6654** | - | - |

> **性能与吞吐概览**：
> - P50 延迟: `469.74 ms` | P95 延迟: `913.92 ms` | 平均注入: `19.18 tokens`
...
| `transient_injection_defense` | 20 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.00 | 0.9500 |
...
| `q_s1_011` | `exact_paraphrase_term` | 20 | 20/0 | 1/19 | 1 | 1.00 | 0 |
| `q_s1_012` | `exact_paraphrase_term` | 20 | 20/0 | 3/17 | 3 | 1.00 | 0 |
| `q_s1_013` | `exact_paraphrase_term` | 20 | 20/0 | 2/18 | 2 | 1.00 | 0 |
...
| `q_s1_027` | `exact_paraphrase_term` | 20 | 20/0 | 1/19 | 1 | 1.00 | 0 |
...
| `q_s2_015` | `scope_isolation` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
...
| `q_s2_025` | `scope_isolation` | 20 | 20/0 | 2/18 | 2 | 0.00 | 0 |
...
| `q_s4_006` | `lifecycle_conflict` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
...
| `q_s4_023` | `lifecycle_conflict` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
| `q_s4_024` | `lifecycle_conflict` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
| `q_s4_025` | `lifecycle_conflict` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
| `q_s5_001` | `temporal_intent` | 20 | 20/0 | 1/19 | 1 | 1.00 | 0 |
| `q_s5_002` | `temporal_intent` | 20 | 20/0 | 2/18 | 2 | 1.00 | 0 |
| `q_s5_003` | `temporal_intent` | 20 | 20/0 | 3/17 | 3 | 0.00 | 0 |
...
| `q_s5_009` | `temporal_intent` | 20 | 20/0 | 2/18 | 2 | 1.00 | 0 |
...
| `q_s5_015` | `temporal_intent` | 20 | 20/0 | 3/17 | 3 | 1.00 | 0 |
...
| `q_s6_013` | `multi_evidence` | 20 | 20/0 | 2/18 | 2 | 0.50 | 0 |
| `q_s6_014` | `multi_evidence` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
| `q_s6_015` | `multi_evidence` | 20 | 20/0 | 0/20 | 0 | 0.00 | 0 |
...
| `q_s8_006` | `transient_injection_defense` | 20 | 20/0 | 2/18 | 2 | 0.00 | 0 |
