...
REMOTE_HOST="${HIPPO_DOCS_HOST:-your-server}"
REMOTE_DIR="${HIPPO_DOCS_DIR:-/opt/docs/hippo}"
TS_IP="${HIPPO_TAILSCALE_IP:-100.x.x.x}"
TS_DOMAIN="${HIPPO_TAILSCALE_DOMAIN:-your-server.tailnet.ts.net}"
...
echo "==> [3/3] 部署完成！"
echo "==> 访问入口 (Tailscale 私网，零公网暴露):"
echo "    - Hippo 文档站:  http://${TS_IP}/hippo/  或  http://${TS_DOMAIN}/hippo/"
echo "    - 统一文档大厅:  http://${TS_IP}/        或  http://${TS_DOMAIN}/"
